...
public class Archivos {
	...
	{	
		...
		String ruta=InformeMets.RUTACOPIAARCHIVO;
		
		File ff = new File(ruta,"copias de archivo.txt");
	...
	public static ArrayList<String>  leerFichero (String archivo,String archivo2) throws IOException
	 {
		...
		String linea2=null;;
		int size=MetodosComplementarios.contarLineas(archivo);
   ...
   public static void imprimirNuevoFichero (ArrayList<String> linea){
	
	 File ff = new File(InformeMets.RUTAMETSREPETIDOS,MetodosComplementarios.nombraArchivo());
	 try{
